...
md"El Capitán James Lovell y su transferencia fálica, digo, la maqueta de la nave Gemini 12"
...
El Capitán Lovell, lamentablemente, está atado a las molestas leyes de la física. Por eso su frase más memorable es \"Houston, we have a problem\". Su nave puede acelerar a razón de $10 m/s^2$, aproximadamente 2 veces la aceleración de la gravedad (más que eso por tiempos prolongados pondría en riesgo su físico).

Vamos a graficar la posición de los tres capitanes como función del tiempo."
...
plot!([384000], seriestype="hline", lab="Luna", linestyle=:dot)
